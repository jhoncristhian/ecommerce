...
<div class="container search-page">
            ...
            <div class="card hoverable animated slideInUp wow">
                <div class="card-image">
                    <a href="product.php?id=<?= $id_product; ?>">
                        <img src="src/img/products/<?= $thumbnail_product; ?>"></a>
                ...
                <div class="card-action">
                    <div class="container-fluid">
                        <h5 class="white-text">S/. <?= $price_product; ?></h5>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="center-align animated slideInUp wow">
        <ul class="pagination <?php if($total<15){echo "hide";} ?>">
            <li class="<?php if($page == 1){echo 'hide';} ?>"><a href="?page=<?php echo $page-1; ?>&per-page=15"><i
            ...
            <?php endfor; ?>
            <li class="<?php if($page == $y){echo 'hide';} ?>"><a href="?page=<?php echo $page+1; ?>&per-page=15"><i
