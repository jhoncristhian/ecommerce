<div class="navbar-fixed">
    <nav class="navblack">
        <div class="nav-wrapper nav-wrapper-2 container">
            ...
            <li><a href="index.php" class="dark-text">Productos</a></li>
            <li><a href="index.php" class="dark-text">Precios</a></li>
                <li><a href="index.php" class="dark-text">Recursos</a></li>
                <li><a href="index.php" class="dark-text">Contactanos</a></li>
