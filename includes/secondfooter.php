    ...
    <div class="container footer-info">
        <div class="row">
            <div class="col s12 l4 ">
                ...
                <ul>
                    <li><a class="grey-text text-lighten-3 animated slideInUp wow" href="https://github.com/sohammanjrekar"><i class="tiny material-icons" style="position:relative;top:3px">developer_mode</i> Jhon Cristhian Parco</a></li>
